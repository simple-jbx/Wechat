		...
		<!-- 设置上传相关参数 -->
   		<script>  
		    $("#fileUpload").fileinput({  
		        language : "zh",//设置语言  
		        uploadUrl: "<%=session.getAttribute("basePath")%>/upLoadServlet.do?tableName=yh",//上传地址  
		        textEncoding: 'utf-8',
	...
	$(function(){
		...
		ajax : function (request) {
	        $.ajax({
	            ...
	            url : '<%=session.getAttribute("basePath")%>/YHGLController.do',
				dataType:"json",
			...
			columns: [{
				...
				formatter: function (value, row, index) {  
		                   ...
		                   var q = '<button class = "reset" href="javascript:void(0)">密码重置</button>';
		                   return s + b + q;  
                },  

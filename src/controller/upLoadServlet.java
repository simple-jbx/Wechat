...
//                        sb.setLength(0);  
                    ...
                    if(!StringUtils.isEmpty(tableName)) {
                    	if(tableName.equals("yh"))
                    	{
                    		//System.out.println(tableName);
                    		YHService yhService = new YHService();
                    		yhService.save2DB(realSavePath + "\\" + saveFilename);
                    		//System.out.println(realSavePath + "\\" + saveFilename);
                    	}else if(tableName.equals("gjzxj")) {
                    		GJZXJService gjzxjService = new GJZXJService();
                    		gjzxjService.save2DB(realSavePath + "\\" + saveFilename);
                    	}else if(tableName.equals("qgzx")) {
                    		QGZXService qgzxService = new QGZXService();
                    		qgzxService.save2DB(realSavePath + "\\" + saveFilename);
                    	}else if(tableName.equals("mfsfsshbz")) {
                    		MFSFSSHBZService mfsfsshbzService = new MFSFSSHBZService();
                    		mfsfsshbzService.save2DB(realSavePath + "\\" + saveFilename);
                    	}               	
                    }                  
